...
const CommodalU = ({ selectedUser, setSelectedUser }) => {
  ...
  const [newFirmaPozice, setNewFirmaPozice] = useState(selectedUser.firmaPozice);
        ...
        <div className="modalwrapper">
          <div className="main-content">
            ...
            <div className="comm-grid">
              ...
              <img src="https://genusio.com/img/blank.jpg" alt="think bigger!" />
...
{/* //-----------------------         */}
          ...
          <FormGroup>
          <FormControlLabel control={<Checkbox color="secondary" value={1} defaultChecked={checkArr1.includes(1) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Chci znát hodnotu mé komunity" />
          <FormControlLabel control={<Checkbox color="secondary" value={2} defaultChecked={checkArr1.includes(2) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Rád bych získal/a sponzoring na rozvoj mé komunity" />
          <FormControlLabel control={<Checkbox color="secondary" value={3} defaultChecked={checkArr1.includes(3) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Zvažuji svou komunitu prodat" />              
          <FormControlLabel control={<Checkbox color="secondary" value={4} defaultChecked={checkArr1.includes(4) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Chci koupit zajímavé komunity" />              
          <FormControlLabel control={<Checkbox color="secondary" value={5} defaultChecked={checkArr1.includes(5) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Chci sponzorovat zajímavé komunity" />              
          <FormControlLabel control={<Checkbox color="secondary" value={6} defaultChecked={checkArr1.includes(6) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Hledám interního člověka na pozici Community či Brand Manager" />              
          <FormControlLabel control={<Checkbox color="secondary" value={7} defaultChecked={checkArr1.includes(7) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Hledám agenturu či externího specialistu na Community Development" />              
          <FormControlLabel control={<Checkbox color="secondary" value={8} defaultChecked={checkArr1.includes(8) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Rád bych nabídl/a své služby v zajímavých komunitách" />              
          <FormControlLabel control={<Checkbox color="secondary" value={9} defaultChecked={checkArr1.includes(9) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Chci mít přístup k neveřejným obchodním nabídkám a možnost je distribuovat" />              
          <FormControlLabel control={<Checkbox color="secondary" value={10} defaultChecked={checkArr1.includes(10) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Líbí se mi myšlenky a vize Jakuba Pacandy" />              
          <FormControlLabel control={<Checkbox color="secondary" value={11} defaultChecked={checkArr1.includes(11) ? 'defaultChecked' : ''} onChange={(e)=>getToolsValue(e)} />} label="Zatím nevím" />              
          </FormGroup>
