...
const list = (anchor) => (
  ...
  >
    <List>
      <ListItem style={{justifyContent:"center"}}>{user.username}</ListItem>
      </List>
      <Divider />
      <List>
...
// list end
  ...
  <li className="nav-item active">
  <a href="https://www.jakubpacanda.cz/wuwejcommunity-pozvanka" target="_blank" rel="noreferrer">Wuwej Community</a>
          </li>
