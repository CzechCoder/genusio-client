            ...
            >
              <div className="form-group">
                ...
                <FormLabel component="legend">
                  Vypíchněte největší užitky vaší komunity. Buďte konkrétní a
                  myslete na detaily. Max 200 znaků.
                </FormLabel>
                <TextField
                ...
                <FormLabel component="legend">
                  Nástroje musí být diskusního (nikoli reklamního) charakteru.
                  Například firemní stránka na Facebooku je reklamního
                  charakteru. Komunikace je obvykle jednosměrná od vlastníka
                  směrem ke sledujícím odběratelům. Narozdíl od toho Facebook
                  skupina je nástroj, kde se členové mohou sdružovat, diskutvat
                  a propojovat se spolu i bez účasti lídra. Samozřejmně i osobní
                  setkání, eventy a konference se počítají.
                </FormLabel>
                ...
                <h5>
                  Nenašli jste Vaši oblíbenou platformu v našem seznamu? Dejte
                  nám tip na doplnění. <i>(nepovinné)</i>
                </h5>
                <TextField
                  size="small"
                  variant="standard"
                ...
                <Button
                  variant="contained"
                  disabled={!communityname || !membersCount}
                  style={{ width: "100%" }}
